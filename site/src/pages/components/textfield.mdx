...
<Prop name="multiline" type="bool">
  Renders a multiline textarea
</Prop>

<Prop name="type" type="string" defaultValue="text">
...
<Prop name="resize" type="string">
  none, both, horizontal, vertical, block, inline <br />A value to determine how
  a multiline input can be resized
</Prop>

...
These guidelines are used to maintain readability, and establish visual heirarchy.
...
When Calibre is unavailable, our base font stack token, <Token name='font-family-base'/>, defaults to native system font families. A monospace token, <Token name='font-family-monospace' />, is also availble with sensible system defaults.

---
### Size, Line Height, and Weight
Three font weights are most used: **400**, **500**, and **600**. While **300** is available, it should be used sparingly.

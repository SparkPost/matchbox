  ...
  <Box position="relative">
    <Button.Group>
      <Tooltip id="test-tooltip" content="Hellow I am a Tooltip">
        <Button aria-describedby="test-tooltip" onClick={() => console.log('click')} outline>
...
export const StyledWithSystemProps = () => (
  <div>
    <Tooltip
      id="test-tooltip-1"
...
export const WithinAbsoluteContainer = () => (
  <Box>
...
export const AroundABlockElement = () => (
  <Box>
    <Tooltip
      id="test-tooltip"
      as="div"
